...
public class Pipeline0Command extends CommandBase {
  ...
  public Pipeline0Command(LimelightSubsystem limelightSubsystem, LEDSubsystem ledSubsystem) {
  ...
  @Override
  public void execute() {
    limelightSubsystem.setPipeline(Constants.VisionConstants.Cube_Pipeline);
  }
